...
function w(b, c) {
  ...
  for (var a = [], e, d, f, h = 0; h < c.length; h++)
    (e = D(b, c[h].x, c[h].y)),
      ...
      (f = a.length - 1),
      0 <= f &&
        (l(e, a[f]) ? (d = !1) : 0 < f && k(a[f - 1], a[f], e) && a.pop()),
      d && a.push(e);
  f = a.length - 1;
...
E.prototype = {};
function F(b, c, l, k) {
  this.q = b ? b : { x: Number.POSITIVE_INFINITY, y: Number.POSITIVE_INFINITY };
  this.l = c ? c : { x: Number.NEGATIVE_INFINITY, y: Number.NEGATIVE_INFINITY };
  this.t = l;
  this.s = k;
  this.depth = -1;
}
  ...
  P: function(b) {
    ...
    for (l = this.B.length; c < l; c++) {
      ...
      if (1 == d.depth % 2) {
        ...
        null != d.q.id && (e[d.q.id] = f), null != d.l.id && (e[d.l.id] = h);
    }
    var t;
    for (c = 0; c < k; c++)
  ...
  for (var e; a; )
    if (a.V) a = -1 == r.c.G(l == a.V ? k : l, a.V) ? a.left : a.right;
      ...
      if (l == a.h.a || l == a.h.i)
        ...
        (e = M(a.h, l)),
          0 == e &&
            ((e = M(a.h, k)), 0 == e && (e = M(a.h, c ? b.o.a : b.m.i)));
      if (0 < e) a = a.left;
      ...
      do {
        for (t = 1 == p % 2; (g = f.pop()); )
          -1 == g.depth &&
            ...
            (s = g.s)) &&
            (-1 == s.K.depth && h.push(s.K), s.p != t && (e.F[s.O] = !1));
        f = h;
        h = [];
        p++;
      } while (0 < f.length);
